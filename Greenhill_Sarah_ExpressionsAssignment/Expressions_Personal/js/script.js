...
var totalMedEnergyMissed = totalMissed * medValue; //This calculates the total amount of energy Sarah lacks at the end of the week
...
console.log("Sarah started with " + totalEnergy + "% energy at the beginning of the week, and ended up with " + endWeekEnergy + ". Taking all meds and resting for one day will leave Sarah with " + netEnergy0 + " energy. Two rest days will leave her with " + netEnergy1 + " energy. Three rest days will leave her with " + netEnergy2  + " energy. Four full rest days will leave Sarah with " + netEnergy3 + " energy.") //Output of Sarah's total energy to start, at the end of the week, and what it will be with different amounts of rest/full meds